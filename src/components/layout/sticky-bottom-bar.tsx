...
type StickyBottomBarProps = React.HTMLAttributes<HTMLDivElement> & {
...
export function StickyBottomBar({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "mx-auto flex max-w-6xl flex-col gap-3 px-4 pb-[max(0.75rem,env(safe-area-inset-bottom,0px))] pt-3",
          innerClassName,
        )}
        role="region"
