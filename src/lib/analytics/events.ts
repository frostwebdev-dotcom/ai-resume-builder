...
export const ANALYTICS_EVENTS = {
  ...
  MOBILE_BUILD_TAB_SELECTED: "mobile_build_tab_selected",
  MOBILE_PREVIEW_TAB_SELECTED: "mobile_preview_tab_selected",
  RESUME_READINESS_WARNING_SHOWN: "resume_readiness_warning_shown",
  IMPROVE_WITH_AI_FROM_PREVIEW_CLICKED: "improve_with_ai_from_preview_clicked",
